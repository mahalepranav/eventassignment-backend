...
const createEvent = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ msg: "Error in creating event", error: err.message });
  }
};
...
const updateEvent = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "Event updated successfully", data: updatedEvent });
  } catch (err) {
...
const deleteEvent = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "Event deleted successfully", data: deletedEvent });
  } catch (err) {
